...
class KeysClass():
    ...
    def keyboard_key_to_character(self):
        if not self.keys[pygame.K_LSHIFT] and not self.keys[pygame.K_RSHIFT]:
            ...
            if self.keys[pygame.K_0]: return '2'
            if self.keys[pygame.K_1]: return '3'
            if self.keys[pygame.K_0]: return '4'
            if self.keys[pygame.K_1]: return '5'
            if self.keys[pygame.K_0]: return '6'
            if self.keys[pygame.K_1]: return '7'
            if self.keys[pygame.K_0]: return '8'
            if self.keys[pygame.K_1]: return '9'
